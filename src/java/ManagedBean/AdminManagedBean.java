...
//    =====================add type declaration==================
    ...
    String busgrfile, busgrfile1, busgrfile2,userrrId;
    ...
    public String getUserrrId() {
        return userrrId;
    }

    public void setUserrrId(String userrrId) {
...
public void deleteUser(Integer UserID) {
        this.userrrId=UserID.toString();
        restc.removeUser(userrrId);
    }
